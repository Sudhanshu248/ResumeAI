...
export default function Footer() {
    return (
        // Main footer container with top border and excluded from print
        <div className="container border-top" id="no-print">
            
            <div className="rows">

                {/* Left section: Branding and quick links */}
                <div className="left-part">
                    {/* Branding text */}
                    <div className="footer-text p-4">
                        <h3 className="p-3 footer-text" style={{ width: "100%" }}>
                            AI Powered Resume <br /> Builder
                        </h3>
                        <p className="ps-3 pe-3">
                            Let's create your AI-powered resume for your next big job.
                        </p>
                    </div>
                ...
                {/* Right section: Resources and social media */}
                    ...
                    <div className="links">
                        <div className="sub-link text-center">
                            ...
                            <div className="d-flex flex-direction-column m-3">
                                <a href="https://www.instagram.com/beast__ashu__/" target="_blank" className="m-2">
                                    <i className="fa-brands fa-instagram"></i>
                                </a> <br />
                                <a href="https://www.linkedin.com/in/sudhanshusaini24" target="_blank" className="m-2">
                                    <i className="fa-brands fa-linkedin-in"></i>
                                </a><br />
                                <a href="mailto:hk1832141@gmail.com" target="_blank" className="m-2">
