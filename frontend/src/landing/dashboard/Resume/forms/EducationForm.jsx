...
export default function EducationForm({ enableNext }) {
  ...
  // const prompt = `Write a short academic summary in 2 bullet points for a person has ${education?.degree} in ${education?.field} from  ${education?.institution} , highlighting key learnings or projects`
// const prompt = `Write a short academic summary in 2 bullet points for a person has ${education[0]?.degree} in ${education[0]?.field} from ${education[0]?.institution}, highlighting key learnings or projects`;
