...
export default function EducationForm({ enableNext }) {
    ...
    const [education, setEducation] = useState(resumeData?.education || [{ ...defaultEducation }]);
    ...
    return (
        <div className="pt-2 pb-5 ps-3 pe-3 rounded-4 mt-4" style={{
            height: "fit-content",
                ...
                {education.map((item, index) => (
                    <div key={item.id} className="row g-2 justify-content-between mb-4">
                        ...
                        <div className="col d-flex flex-column">
                            ...
                            <input type="text" name="universityName" value={item.universityName} onChange={(e) => handleChange(e, index)} className="p-1" required />
                        </div>

                        <div className="col d-flex flex-column">
                            <label className="fw-medium">Degree</label>
                            <input type="text" name="degree" value={item.degree} onChange={(e) => handleChange(e, index)} className="p-1" required />
                        </div>

                        <div className="col d-flex flex-column">
                            <label className="fw-medium">Field of Study</label>
                            <input type="text" name="fieldofstudy" value={item.fieldofstudy} onChange={(e) => handleChange(e, index)} className="p-1" required />
                        </div>

                        <div className="col d-flex flex-column">
                            <label className="fw-medium">Start Date</label>
                            <input type="date" name="startDate" value={item.startDate} onChange={(e) => handleChange(e, index)} className="p-1" required />
                        </div>
