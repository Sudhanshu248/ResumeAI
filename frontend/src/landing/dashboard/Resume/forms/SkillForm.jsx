...
export default function SkillForm({ enableNext }) {
    const { resumeData, setResumeData, updateSkills } = useResume();
    const [loading, setLoading] = useState(false);
    const [skills, setSkills] = useState(resumeData?.skills || [initialSkill()]);
    ...
    const handleSubmit = (e) => {
        ...
        updateSkills({ skills }); // ✅ Use context method
